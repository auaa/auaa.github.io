(function(t, e) {
    ...
    if (d.stringify = d.stringify || d.encode, d.parse = d.parse || d.decode, void 0 !== c.init) throw new Error("History.js Core has already been loaded...");
    c.init = function(t) {
        ...
        if (c.initCore.initialized = !0, c.options = c.options || {}, c.options.hashChangeInterval = c.options.hashChangeInterval || 100, c.options.safariPollInterval = c.options.safariPollInterval || 500, c.options.doubleCheckInterval = c.options.doubleCheckInterval || 500, c.options.disableSuid = c.options.disableSuid || !1, c.options.storeInterval = c.options.storeInterval || 1e3, c.options.busyDelay = c.options.busyDelay || 250, c.options.debug = c.options.debug || !1, c.options.initialTitle = c.options.initialTitle || n.title, c.options.html4Mode = c.options.html4Mode || !1, c.options.delayInit = c.options.delayInit || !1, c.intervalList = [], c.clearAllIntervals = function() {
            ...
            for (e ? (o = (l = Array.prototype.slice.call(arguments)).shift(), void 0 !== i.debug ? i.debug.apply(i, [o, l]) : i.log.apply(i, [o, l])) : o = "\n" + t + "\n", r = 1, a = arguments.length; r < a; ++r) {
                if ("object" == typeof(h = arguments[r]) && void 0 !== d) try {
                    h = d.stringify(h)
                } catch (t) {}
                o += "\n" + h + "\n"
            }
            return s ? (s.value += o + "\n-----\n", s.scrollTop = s.scrollHeight - s.clientHeight) : e || u(o), !0
            ...
            var e = c.extractId(t.url),
                i;
            if (!e) if (i = c.getStateString(t), void 0 !== c.stateToId[i]) e = c.stateToId[i];
            ...
            if (void 0 !== t ? c.busy.flag = t : void 0 === c.busy.flag && (c.busy.flag = !1), !c.busy.flag) {
                ...
                var e = function() {
                    var t, i, n;
                    if (!c.busy.flag) for (t = c.queues.length - 1; t >= 0; --t) 0 !== (i = c.queues[t]).length && (n = i.shift(), c.fireQueueItem(n), c.busy.timeout = r(e, c.options.busyDelay))
                };
            ...
            var i;
            if (t > 0) for (i = 1; i <= t; ++i) c.forward(e);
            else {
        ...
        if (o) {
            try {
                c.store = d.parse(o.getItem("History.store")) || {}
            } catch (t) {
                c.store = {}
            }
            c.normalizeStore()
        ...
        c.Adapter.bind(t, "unload", c.clearAllIntervals), c.saveState(c.storeState(c.extractState(c.getLocationHref(), !0))), o && (c.onUnload = function() {
            ...
            c.store = t, c.normalizeStore(), i = d.stringify(t);
            try {
    ...
    return n._resetLayout = function() {
        ...
        for (var h, d = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, u = a; l >= u; u++) this.colYs[u] = Math.max(d, this.colYs[u])
    ...
    i.throttle = n = function(t, n, s, o) {
        function r() {
            ...
            var h = this,
                d = +new Date - l,
                u = arguments;
            o && !a && i(), a && clearTimeout(a), o === e && d > t ? i() : !0 !== n && (a = setTimeout(o ? r : i, o === e ? t - d : t))
        }
        var a, l = 0;
    ...
    t.extend(s.prototype, {
        ...
        open: function() {
            var e = this,
                ...
                s = i.find(".fluidbox__ghost"),
                o = i.find(".fluidbox__wrap");
            e.instanceData.state = 1, s.off(u), t(".fluidbox--opened").fluidbox("close");
            var r = t("<div />", {
            ...
            s.css({
                ...
                opacity: 1
            }), c.measure.fbElements.call(e), e.settings.immediateOpen ? (i.addClass("fluidbox--opened fluidbox--loaded").find(".fluidbox__wrap").css({
        ...
        compute: function() {
            var e = this,
                ...
                f, g, m, v, y;
            e.settings.maxWidth > 0 ? h = (a = e.settings.maxWidth) / c : e.settings.maxHeight > 0 && (a = (h = e.settings.maxHeight) * c), p > c ? (v = a * (u * (m = (f = h < l.viewport.h ? h : l.viewport.h * e.settings.viewportFill) / u) / h) / d, y = m) : (m = h * (d * (v = (g = a < l.viewport.w ? a : l.viewport.w * e.settings.viewportFill) / d) / a) / u, y = v), e.settings.maxWidth && e.settings.maxHeight && console.warn("Fluidbox: Both maxHeight and maxWidth are specified. You can only specify one. If both are specified, only the maxWidth property will be respected. This will not generate any error, but may cause unexpected sizing behavior.");
            var _ = o.scrollTop() - n.offset().top + u * (y - 1) * .5 + .5 * (o.height() - u * y),
                w = d * (y - 1) * .5 + .5 * (o.width() - d * y) - n.offset().left,
    ...
    (function() {
        return !!s("transition")
    })() && (t.support.transition = new String(o("transition")), t.support.transition.end = l.transition.end[t.support.transition]), c() && (t.support.animation = new String(o("animation")), t.support.animation.end = l.animation.end[t.support.animation]), h() && (t.support.transform = new String(o("transform")), t.support.transform3d = d())
...
//         })
//     }
//     var i = t("body").data("page-url"),
//         n = document.title,
//         s = window.History,
//         o = t(".page__content").data("image");
//     s.Adapter.bind(window, "statechange", function() {
//         var r = s.getState();
//         t("body").addClass("loading");
//         t(".page-loader").load(r.hash + " .page__content", function() {
//             var s = 400;
//             setTimeout(function() {
//                 t("body, html").animate({
//                     scrollTop: 0
//                 }, 0), t(".page .page__content").remove(), t(".page-loader .page__content").appendTo(".page"), t("body").attr("data-page-url", window.location.pathname), i = t("body").attr("data-page-url"), n = t(".page__content").attr("data-page-title"), document.title = n;
//                 var s = t(".page__content").attr("data-image");
